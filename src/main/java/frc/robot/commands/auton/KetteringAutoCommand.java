...
public class KetteringAutoCommand extends SequentialCommandGroup implements AutoCommandInterface {
  ...
  public KetteringAutoCommand(
    ...
    bargeToAlgaePath = new DriveAutonCommand(driveSubsystem, bargeToAlgae, true, false, false);
    bargeToReefPath =
