...
public class DriveAlgaeWaitAutonServoCommand extends Command implements AutoCommandInterface {
  ...
  private double raiseElevAfterTime = 0.0;

  private SwerveSample desiredState;
  private Pose2d initialPose = new Pose2d();
  private Pose2d finalPose = new Pose2d();

  public DriveAlgaeWaitAutonServoCommand(
    ...
    this.raiseElevAfterTime = raiseElevAfterTime;
