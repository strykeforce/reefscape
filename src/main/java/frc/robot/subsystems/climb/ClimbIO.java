...
public interface ClimbIO {
  ...
  public default void setRatchetServoPosition(
      double position) {} // needed? since it's double, not angle

  public default void setPinServoPosition(
      double position) {} // may make a method to stick these both into one method
